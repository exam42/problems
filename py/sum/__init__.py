...
def sum_2_3():
    """sum_2_3"""
    test_input_output("python3 sum.py", "sum_2_3_input.txt", "sum_2_3_output.txt")


@check50.check(exists)
def sum_20_22():
    """sum_20_22"""
    test_input_output("python3 sum.py", "sum_20_22_input.txt", "sum_20_22_output.txt")


@check50.check(exists)
def sum_10_20():
    """sum_10_20"""
    test_input_output("python3 sum.py", "sum_10_20_input.txt", "sum_10_20_output.txt")
